...
> 呼叫結束了，工作還沒有。從 id 公開出去的那一刻起，發動它的那次呼叫再喊停也沒人收，還按得到停止鍵的手，只剩擁有者那一隻。
...
所有連結都指向鎖定的那個 Studied version，[`99f6f02`](https://github.com/deepseek-ai/deepseek-harness/tree/99f6f02fecdb7dff40c3fbc9470f5907c29f74ca)。這一層對應的套件家族是 [`packages/jobs`](https://github.com/deepseek-ai/deepseek-harness/tree/99f6f02fecdb7dff40c3fbc9470f5907c29f74ca/packages/jobs)。
...
真正的 jobs 這一層，在這個 Section 的 Mechanism 之上還多做了什麼：
